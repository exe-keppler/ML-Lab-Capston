...
# Mapeo de nombres CICFlowMeter -> nombres CICIDS2017 procesado
CICFLOW_TO_MODEL = {
    'flow_duration': 'Flow Duration',
    'total_fwd_packets': 'Total Fwd Packets',
    'total_bwd_packets': 'Total Backward Packets',
    'total_len_of_fwd_packets': 'Fwd Packets Length Total',
    'total_len_of_bwd_packets': 'Bwd Packets Length Total',
...
def inject_dataset_flows(attack_type, n_per_cat=5):
    ...
    try:
        ...
        # Cargar dataset procesado (el sensor monta los mismos datos)
        DATA_PATH = '/app/data/cicids2017_processed.parquet'
        if not os.path.exists(DATA_PATH):
            print("[Inject] Dataset no disponible en sensor, usando API directa")
            return [], []
